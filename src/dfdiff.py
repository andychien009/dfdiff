...
parser.add_argument('--key', nargs='+', required=True, help="The list of join key to be used for joining the left and right table/csv. Composite key is supported, separated by space and optionally enclosed by double quote if necessary.")
...
cmp = dfdiff(left, right, uargs.key)
